...
$fname = $lname = $username = $profile_src  = $time = $cover_src = "";//Login
$time = time();
...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
     ...
     <img src="img/message.png" class="ml-2">
            ...
            <div class="container story">
                <div class="row"> 
                    ...
                    <div class="col-md-3 s2">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/65159273_411098709615751_7966364241802297344_o.jpg?_nc_cat=101&ccb=2&_nc_sid=e3f864&_nc_ohc=olHZ6_SxmyQAX9klpEU&_nc_ht=scontent.fbir2-1.fna&oh=51f98ca40a4836117d586351a9b012dc&oe=5FC4D308" class="img-fluid">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/24129937_149388279120130_8622121179528379213_n.jpg?_nc_cat=102&ccb=2&_nc_sid=09cbfe&_nc_ohc=N98dm6Z3CeYAX9qOzoX&_nc_ht=scontent.fbir2-1.fna&oh=753466103404f70da19750c4a43b7e85&oe=5FC66335" id="user_profile_pic">
                        <h6 id="story_title">Bishworaj Poudel</h6>
                    </div>
                    <div class="col-md-3 s3">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/70930560_146238673293229_2672586512817717248_n.jpg?_nc_cat=110&ccb=2&_nc_sid=174925&_nc_ohc=9r0phQdet3sAX80seaU&_nc_oc=AQkK9J_hvGn1iC3CEJ1U4CgvRH6ffxv-fsaF-ScbIj-NLn7X4xUMP_1B_vkCR8lC7y8&_nc_ht=scontent.fbir2-1.fna&oh=a2d2b905c7e4511ca1b2e00acba46860&oe=5FC721B0" class="img-fluid">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/100061609_253465195903909_6700921470282891264_o.jpg?_nc_cat=109&ccb=2&_nc_sid=09cbfe&_nc_ohc=5ZDM4jFSg2kAX-tjvKl&_nc_ht=scontent.fbir2-1.fna&oh=a547367cc0649e7405dcd3a51e676ae9&oe=5FC38686" id="user_profile_pic">
                        <h6 id="story_title">Rohit Giri</h6>
                    </div>
                    <div class="col-md-3 s4">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/46524125_596905467409795_4345658046215618560_o.jpg?_nc_cat=109&ccb=2&_nc_sid=e3f864&_nc_ohc=GqRAw-gdnikAX9uqvZs&_nc_ht=scontent.fbir2-1.fna&oh=a5e5348ca35d7de15cefb6a5813e79ca&oe=5FC45740" class="img-fluid">
                        <img src="https://scontent.fbir2-1.fna.fbcdn.net/v/t1.0-9/58444875_681542085612799_7054579157723774976_o.jpg?_nc_cat=106&ccb=2&_nc_sid=09cbfe&_nc_ohc=0fpdGGv0QdcAX8HQhXY&_nc_ht=scontent.fbir2-1.fna&oh=7723d637663c141f6268e0005a1c4862&oe=5FC726EE" id="user_profile_pic">
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="row d-flex pt-2 flex-row">
                            ...
                            <div class="col-md-10 mt-2 pr-5">
                                <textarea id="comment_section" placeholder="Write a comment"></textarea>
                            </div>
                        </div>
                    </div>
...
<!-- profile model  -->
<div class="container profile p-3" style="width: 100%;height: 603px; position: absolute;top: 60px;left:225px;overflow-y: scroll; background-color:white;">
   <div class="row" style="margin-top: -14px;">
       <div class="col-md-12">
           <div class="cover_img" style="height: 350px;width: 900px;background-color: red;overflow-y: hidden;">
           <img src="post_img/<?php echo $cover_src; ?>" class="img-fluid">
           <p id="change_coverPic" style="top:310px;left: 750px; background-color: #f1f1f1;padding: 4px;position: absolute;z-index: 4;border-radius: 4px;cursor: pointer;"><i class="fa fa-camera"></i> Add Cover Photo</p>
       ...
       <h3 style="margin-top: -20px; margin-left: 300px;"><?php echo $username; ?></h3>
